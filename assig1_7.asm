...
int main(void)
{
  ...
  17:	68 26 08 00 00       	push   $0x826
  1c:	6a 01                	push   $0x1
  1e:	e8 9d 04 00 00       	call   4c0 <printf>
  ...
  32:	6a 08                	push   $0x8
  34:	e8 e7 06 00 00       	call   720 <malloc>
  ...
  43:	53                   	push   %ebx
  44:	e8 a1 03 00 00       	call   3ea <recv>
		while(stat==-1){
  ...
  54:	6a 0a                	push   $0xa
  56:	e8 57 03 00 00       	call   3b2 <sleep>
		printf(1,"2 CHILD: msg recv is: %s \n", msg );
  5b:	83 c4 0c             	add    $0xc,%esp
  5e:	53                   	push   %ebx
  5f:	68 2a 08 00 00       	push   $0x82a
  64:	6a 01                	push   $0x1
  66:	e8 55 04 00 00       	call   4c0 <printf>

		exit();
  6b:	e8 b2 02 00 00       	call   322 <exit>
	}else{
		// This is parent
		sleep(10);
  ...
  75:	6a 0a                	push   $0xa
  77:	e8 36 03 00 00       	call   3b2 <sleep>
		char *msg_child = (char *)malloc(MSGSIZE);
  7c:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  83:	e8 98 06 00 00       	call   720 <malloc>
		msg_child = "P";
		send(getpid(),cid,msg_child);	
  88:	e8 15 03 00 00       	call   3a2 <getpid>
  8d:	83 c4 0c             	add    $0xc,%esp
  90:	68 45 08 00 00       	push   $0x845
  95:	53                   	push   %ebx
  96:	50                   	push   %eax
  97:	e8 46 03 00 00       	call   3e2 <send>
		printf(1,"1 PARENT: msg sent is: %s \n", msg_child );
  9c:	83 c4 0c             	add    $0xc,%esp
  9f:	68 45 08 00 00       	push   $0x845
  a4:	68 47 08 00 00       	push   $0x847
  a9:	6a 01                	push   $0x1
  ab:	e8 10 04 00 00       	call   4c0 <printf>
		
		free(msg_child);
  b0:	c7 04 24 45 08 00 00 	movl   $0x845,(%esp)
  b7:	e8 d4 05 00 00       	call   690 <free>
	}
	wait();
  bc:	e8 69 02 00 00       	call   32a <wait>
	exit();
  c1:	e8 5c 02 00 00       	call   322 <exit>
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
...
0000040a <sigpause>:
SYSCALL(sigpause)
 40a:	b8 1f 00 00 00       	mov    $0x1f,%eax
 40f:	cd 40                	int    $0x40
 411:	c3                   	ret    

00000412 <send_multi>:
SYSCALL(send_multi)
 412:	b8 20 00 00 00       	mov    $0x20,%eax
 417:	cd 40                	int    $0x40
 419:	c3                   	ret    
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 490:	e8 ad fe ff ff       	call   342 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 500:	e8 3d fe ff ff       	call   342 <write>
 ...
 578:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 57a:	e8 c3 fd ff ff       	call   342 <write>
  for(i = 0; fmt[i]; i++){
 ...
 613:	57                   	push   %edi
 614:	53                   	push   %ebx
 615:	e8 28 fd ff ff       	call   342 <write>
        while(*s != 0){
 ...
 667:	e8 d6 fc ff ff       	call   342 <write>
        ap++;
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 63 08 00 00       	mov    $0x863,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 14 0b 00 00    	mov    0xb14,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 14 0b 00 00    	cmp    %eax,0xb14
 777:	89 c2                	mov    %eax,%edx
 779:	75 ed                	jne    768 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 77b:	83 ec 0c             	sub    $0xc,%esp
 77e:	56                   	push   %esi
 77f:	e8 26 fc ff ff       	call   3aa <sbrk>
  if(p == (char*)-1)
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 ...
 7e7:	0b 00 00 
 7ea:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 7f1:	0b 00 00 
    base.s.size = 0;
 7f4:	b8 18 0b 00 00       	mov    $0xb18,%eax
 7f9:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 800:	00 00 00 
