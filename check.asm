...
main(int argc, char **argv)
{
  ...
  // int sum=5;
  int ppid=getpid();
  13:	e8 8a 03 00 00       	call   3a2 <getpid>
  // * data=kanish";
  sigset(&handler);
  ...
  sigset(&handler);
  1d:	68 a0 00 00 00       	push   $0xa0
  22:	e8 cb 03 00 00       	call   3f2 <sigset>
  printf(1, "signal registered successfully\n");
  27:	59                   	pop    %ecx
  28:	5e                   	pop    %esi
  29:	68 3c 08 00 00       	push   $0x83c
  2e:	6a 01                	push   $0x1
  30:	e8 8b 04 00 00       	call   4c0 <printf>
  int child = fork();
  35:	e8 e0 02 00 00       	call   31a <fork>
  if (child == 0) {
  ...
  53:	8d 45 e0             	lea    -0x20(%ebp),%eax
  56:	6a 01                	push   $0x1
    recids[0]=child;
  58:	89 75 dc             	mov    %esi,-0x24(%ebp)
    msgarr[0]=ppid;
  5b:	89 5d e0             	mov    %ebx,-0x20(%ebp)
    msgarr[1]=5962;
  5e:	c7 45 e4 4a 17 00 00 	movl   $0x174a,-0x1c(%ebp)
    int r=send_multi(5,recids,(void*)msgarr,1);
  65:	50                   	push   %eax
  66:	8d 45 dc             	lea    -0x24(%ebp),%eax
  69:	50                   	push   %eax
  6a:	6a 05                	push   $0x5
  6c:	e8 a1 03 00 00       	call   412 <send_multi>
    printf(1, "signal sent and returned %d\n",r);
  71:	83 c4 1c             	add    $0x1c,%esp
  74:	50                   	push   %eax
  75:	68 a8 08 00 00       	push   $0x8a8
  7a:	6a 01                	push   $0x1
  ...
  wait();
  81:	e8 a4 02 00 00       	call   32a <wait>
  printf(1, "Handled the signal and continued the program!\n");
  86:	58                   	pop    %eax
  87:	5a                   	pop    %edx
  88:	68 5c 08 00 00       	push   $0x85c
  8d:	6a 01                	push   $0x1
  8f:	e8 2c 04 00 00       	call   4c0 <printf>

  exit();
  94:	e8 89 02 00 00       	call   322 <exit>
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
...
void handler(int sender,int data) {
  ...
  ae:	68 18 08 00 00       	push   $0x818
  b3:	6a 01                	push   $0x1
  b5:	e8 06 04 00 00       	call   4c0 <printf>
  d=data;
  ba:	89 1d 94 0b 00 00    	mov    %ebx,0xb94
  exit();
  c0:	e8 5d 02 00 00       	call   322 <exit>
  c5:	66 90                	xchg   %ax,%ax
  c7:	66 90                	xchg   %ax,%ax
  c9:	66 90                	xchg   %ax,%ax
  cb:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb c5 08 00 00       	mov    $0x8c5,%ebx
        while(*s != 0){
