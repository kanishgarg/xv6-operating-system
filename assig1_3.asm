...
main(void)
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	...
	sleep(100);	
  11:	6a 64                	push   $0x64
  13:	e8 1a 03 00 00       	call   332 <sleep>
	printf(1, "\nsum of 2 and 3 is: %d\n",add(2,3));
  18:	58                   	pop    %eax
  19:	5a                   	pop    %edx
  1a:	6a 03                	push   $0x3
  1c:	6a 02                	push   $0x2
  1e:	e8 2f 03 00 00       	call   352 <add>
  23:	83 c4 0c             	add    $0xc,%esp
  26:	50                   	push   %eax
  27:	68 98 07 00 00       	push   $0x798
  2c:	6a 01                	push   $0x1
  2e:	e8 0d 04 00 00       	call   440 <printf>
	sleep(100);
  33:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  3a:	e8 f3 02 00 00       	call   332 <sleep>
	exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb b0 07 00 00       	mov    $0x7b0,%ebx
        while(*s != 0){
 ...
 611:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 767:	0a 00 00 
 76a:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 60 0a 00 00       	mov    $0xa60,%eax
 779:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 780:	00 00 00 
